...
from data import VOCdir, COCOdir
from data import AnnotationTransform, COCODetection, VOCDetection, BaseTransform, VOC_300, COCO_300
...
parser.add_argument('-m', '--trained_model', default='weights/VOC/LFIP_VOC_300/Final_LFIP_vgg_VOC.pth',
...
cfg = VOC_300 if args.dataset == 'VOC' else COCO_300

if args.dataset == 'VOC':
    from models.LFIP_VOC_300 import build_net
elif args.dataset == 'COCO':
    from models.LFIP_COCO_300 import build_net
else:
...
if __name__ == '__main__':
    ...
    net.eval()
    print('Finished loading LFIP model!')
    print(net)

    if args.dataset == 'VOC':
        testset = VOCDetection(VOCdir, [('2007', 'test')], None, AnnotationTransform())
    elif args.dataset == 'COCO':
